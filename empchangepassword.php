...
{
	$sql = "UPDATE admin SET password='$_POST[npass]',cpassword='$_POST[cpass]' WHERE adminid='$_SESSION[adminid]' AND password='$_POST[opass]'";
...
function validateform()
{
	...
	{
		document.getElementById("idopass").innerHTML ="should have 7 to 15 characters which contain only characters, numeric digits, underscore and first character must be a letter..";	
		i=1;		
	}
