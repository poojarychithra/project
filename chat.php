...
<!------ Include the above in your HEAD tag ---------->
	...
	<span></span>
       ...
       <center><h2> <a href="#" id="addClass"><span class="glyphicon glyphicon-comment"></span> Chat with us </h2></center></a>
      
	

<!------
 <a href="#" id="addClass" ><span class="glyphicon glyphicon-comment" ></span> Chat with Us </a>---------->
...
<div class="popup-box chat-popup" id="qnimate" >
    		  <div class="popup-head">
				...
				?>
				<?php echo $rsproduct1[adminname]; ?></div>
...
setInterval(function(){
   loadmessage('<?php echo $receiverid; ?>','<?php echo $receiverid; ?>'; ?>'); // this will run after every 5 seconds
}, 5000);
</script>
<script>
