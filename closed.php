...
<!-- banner -->
	<div class="banner">
		...
		while($rscategory = mysqli_fetch_array($qsqlcategory))
		{
			...
			$sqlproductcount = "select * from product WHERE status='Active' AND category_id='$rscategory[category_id]'  AND end_date_time<'$dt $tim' ";		
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb"	>
											...
											{
											?>
												<center><h4>No bidding done...</h4></center>
											<?php
											}
											else
											{
											?>	
												<h4>Winning Amount : ₹<?php echo $rsproduct[ending_bid]; ?></h4>
											<?php
											}
											?>
